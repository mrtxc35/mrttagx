...
async def start(event):
  if event.is_private:
    async for usr in client.iter_participants(event.chat_id):
     ...
     await client.send_message(log_qrup, f"👀 **Katıldı -** {ad}")
     return await event.reply(f"{ad} {startmesaj}", buttons=(
                      [
                       Button.inline("📚 Komutlar", data="komutlar")
                      ],
                      [Button.url('➕ Beni Gruba Ekle ➕', f'https://t.me/VahsiTagBot?startgroup=a')],
                      [Button.url('🏹 Grubumuz', f'https://t.me/vahsibatiTR'),
...
async def mentionall(event):
  ...
  if event.pattern_match.group(1):
    ...
    if msg == None:
        return await event.respond("__Eski Mesajlar İle Üyelerden Bahsedemem!  (Beni Gruba Eklemeden Önce Yazılan Mesajlar)__")
  elif event.pattern_match.group(1) and event.reply_to_msg_id:
    return await event.respond("__Etiketleme İşlemini Başlatabilmem İçin Komut İle Birlikte Bir Mesaj Yazman Gerekir ✨!__")
  else:
    return await event.respond("__Etiketleme İşlemini Başlatabilmem İçin Komut İle Birlikte Bir Mesaj Yazman veya Bir Mesaj Yanıtlaman Gerekir ✨!__")
    
  if mode == "text_on_cmd":
    await client.send_message(event.chat_id, "🍃 Etiketleme İşlemi Başlatıldı\n Yardım İçin Buton'a Tıkla!",
                    buttons=(
                      [
                      Button.url('👤 Sahip', f'https://t.me/uslanmazmurti')
                      ]
...
async def mentionalladmin(event):
  ...
  if event.pattern_match.group(1):
    ...
    return await event.respond("__Etiketleme İşlemini Başlatabilmem İçin Komut İle Birlikte Bir Mesaj Yazman veya Bir Mesajı Yanıtlaman Gerekir!__")
    
  if mode == "text_on_cmd":
    await client.send_message(event.chat_id, "🍃 Etiketleme İşlemi Başlatıldı\n Yardım İçin Aşşağıdaki Buton'a Tıkla!",
                    buttons=(
                      [
                       Button.url('👤 Sahip', f'https://t.me/uslanmazmurti')
                      ]
...
async def tektag(event):
  ...
  if event.pattern_match.group(1):
    ...
    return await event.respond("__Etiketleme İşlemini Başlatabilmem İçin Komut İle Birlikte Bir Mesaj Yazman veya Yanıtlaman Gerekir!__")
...
async def etag(event):
  ...
  if event.pattern_match.group(1):
    ...
    return await event.respond("__Etiketleme İşlemini Başlatabilmem İçin Komut İle Birlikte Bir Mesaj Yazman Gerekir__")
  else:
    return await event.respond("__Etiketleme İşlemini Başlatabilmem İçin Komut İle Birlikte Bir Mesaj Yazman veya Yanıtlaman Gerekir__")
...
print(">> Bot Calıyor Merak Etme 🚀 @uslanmazmurti bilgi alabilirsin <<")
